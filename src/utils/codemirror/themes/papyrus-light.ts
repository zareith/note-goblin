// Borrowed from: https://github.com/craftzdog/cm6-themes/blob/main/packages/basic-light/src/index.ts
// with customizations
...
export const papyrusLightTheme = EditorView.theme(
    {
        "&": {
            color: base00,
...
export const papyrusLightHighlightStyle = HighlightStyle.define([
    ...
    { tag: t.heading1, fontWeight: "bold", color: base0A, fontSize: "1.4rem" },
    {
        tag: t.heading2,
        fontWeight: "bold",
        color: base0A,
...
/// the highlight style).
export const papyrusLight: Extension = [
    papyrusLightTheme,
    syntaxHighlighting(papyrusLightHighlightStyle),
